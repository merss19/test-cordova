                    ...
                    <div className="entry__box">
                      {isLate
                        ? <div>
                          ...
                          <br/>
                          <h4>ВАЖНО!! Бегом заполнять анкету в Личном кабинете, загружать фотографию до и читать правила проекта в разделе Вопросы/Ответы. Внимательно ознакомься с этой информацией.</h4>
                          <br/>
