                    ...
                    <div className="accordion__content">
                      <ul className="num-list">
                        ...
                        <li className="num-list__item">
                          ...
                          <p className="num-list__description">
                            У нас нет голосования, у нас всех участники получают призы, а главный приз розыгрывается через генератор случайных чисел. Таким образом, ВСЕ участники получат подарки. Мы считаем, что каждый дошедший до конца достоин поощрения.
                          </p>
                        </li>
                        <li className="num-list__item">
                          <span className="num-list__number">6</span>
